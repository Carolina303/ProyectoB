...
export class ProcesosPage implements OnInit {
  ...
  items = [
    {
      ID: "Pre-Labrado",
      Text: "Labor profunda de subsolado: Cada 2 o 3 años en otoño–invierno, realizamos cortes perpendiculares en el suelo de una profundidad de 40 a 60 cm. para eliminar el llamado piso de arado , aumentar el espesor de la capa roturada, dando a las plantas más espacio para sus raíces y permitir que el agua de riego penetre más en el suelo.",
      Source: "./assets/1subsolado.png"
    },
    {
      ID: "2° Labrado",
    ...
    {
      ID: "Cultivo",
      Text: "Nosotros mismos hacemos la mantención del cultivo del producto, desde lo que es la fertilización orgánica, la fumigación, la poda, la limpieza del producto y el regadío de nuestras plantas.",
      Source: "./assets/4Cultivo.jpg"
    },
    {
      ID: "Cosecha",
